...
The patient histories are shown in 
_Supplemental Figure S3: Clinical timelines._
(this version with legend from my PhD thesis),
<a href="{{ site.baseurl }}{% link images/posts/clinical_history_summary.pdf %}">(pdf version)</a>.

<img 
src="{{ site.baseurl }}{% link images/posts/clinical_history_summary.pdf %}" width="100%">
