...
The analysis protcols use serval stages of best-practice clinical genetic 
annotations accounting for numerous diagnosis criteria including variant consequnce, 
gene ontology, inheritence, protein domain function, transcription editing, 
...
doing tailored bioinformatic analysis is exmplified in the following table. 
...
Instead, the included table is a _very_ simpified example of candidate genes in immunogenics. 
